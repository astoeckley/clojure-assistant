...
(deftest asserts-on
  ...
  (testing "pack"
    ...
    (is ((pack pack1) pack1-is2))
    (is ((pack pack1) (dissoc pack1-is1 :e)))
    (is ((pack pack1) (dissoc pack1-as1 :e)))
    (is ((pack pack1) (dissoc pack1-as2 :f)))
    (is (thrown? AssertionError ((pack pack1) pack1-as1)))
    (is (thrown? AssertionError ((pack pack1) pack1-as2)))
    (is ((pack pack1) (merge pack1-is1 pack1-is2)))
    (is (thrown? AssertionError ((pack pack1) (merge pack1-as1 pack1-is2))))
    (is ((pack pack1) (dissoc (merge pack1-as1 pack1-is2) :e)))
    (is (thrown? AssertionError ((pack pack1) nil)))
    (is (thrown? AssertionError ((pack pack1) {:a 1})))
    (is (thrown? AssertionError ((pack pack1) (dissoc pack1-is1 :d))))
    (is (thrown? AssertionError ((pack pack1) (dissoc pack1-is1 :a))))
    (is (thrown? AssertionError ((pack pack1) (dissoc pack1-is1 :d :b))))
    (is (thrown? AssertionError ((pack pack1) pack1-not1)))
    (is (thrown? AssertionError ((pack pack1) pack1-not2)))
    (is (thrown? AssertionError ((pack nil) pack1-is1))))
...
(deftest asserts-off
  ...
  (testing "pack"
    ...
    (is ((pack pack1) (dissoc pack1-as1 :e)))
    (is ((pack pack1) (dissoc pack1-as2 :f)))
    (is (false? ((pack pack1) pack1-as1)))
    (is (false? ((pack pack1) pack1-as2)))
    (is ((pack pack1) (merge pack1-is1 pack1-is2)))
    (is (false? ((pack pack1) (merge pack1-as1 pack1-is2))))
    (is ((pack pack1) (dissoc (merge pack1-as1 pack1-is2) :e)))
    (is (false? ((pack pack1) nil)))
    (is (false? ((pack pack1) {:a 1})))
    (is (false? ((pack pack1) (dissoc pack1-is1 :d))))
    (is (false? ((pack pack1) (dissoc pack1-is1 :a))))
    (is (false? ((pack pack1) (dissoc pack1-is1 :d :b))))
    (is (false? ((pack pack1) pack1-not1)))
    (is (false? ((pack pack1) pack1-not2))))
  (testing "explain-pack"
    (is (= no-explain (explain-pack pack1 pack1-is1)))
    (is (= no-explain (explain-pack pack1 pack1-is2)))
    (is (= explain-pack1-as1 (explain-pack pack1 pack1-as1)))
